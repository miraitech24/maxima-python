...
1. Maxima（理論的厳密解）:
   ...
   無限級数を用いて、将来の利得をどれだけ重視すれば「裏切り（価格吊り上げ）」が「継続的な協力」を下回るかの境界線 $d = \frac{T - R}{T - P}$ を厳密に導出。
...
これを将来の割引因子 $\delta$ について解いた結果、$\delta > \frac{T-R}{T-P}$ のとき、価格吊り上げは合理的な選択肢から除外されます。
